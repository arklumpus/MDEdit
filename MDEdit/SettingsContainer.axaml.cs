    ...
    internal class SettingsContainer : UserControl
    {
        ...
        public SettingsContainer(Shortcut[] additionalShortcuts)
        {
            ...
            this.FindControl<Button>("DeleteSaveHistoryButton").Click += (s, e) =>
            {
                ...
                try
                {
                    foreach (string file in Directory.EnumerateFiles(autosaveDirectory, "*.md"))
                    {
                        try
                        {
                            File.Delete(file);
            ...
            this.FindControl<CheckBox>("SyntaxHighlightingModeBox").PropertyChanged += (s, e) =>
            {
                if (e.Property == CheckBox.IsCheckedProperty)
                {
                    Editor.EditorControl.SyntaxHighlighting = this.FindControl<CheckBox>("SyntaxHighlightingModeBox").IsChecked == true;
                }
            };
            ...
            this.FindControl<CheckBox>("ShowChangedLinesBox").PropertyChanged += (s, e) =>
            {
                if (e.Property == CheckBox.IsCheckedProperty)
                {
                    ...
                    {
                        DiffResult diffResultFromLastSaved = Editor.Differ.CreateLineDiffs(Editor.LastSavedText, Editor.Text, false);
                        ...
                        DiffResult diffResultFromOriginal = Editor.Differ.CreateLineDiffs(Editor.OriginalText, Editor.Text, false);
