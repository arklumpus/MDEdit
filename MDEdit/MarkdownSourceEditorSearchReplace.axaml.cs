...
namespace MDEdit
{
    internal class MarkdownSourceEditorSearchReplace : UserControl
    {
        public static readonly DirectProperty<MarkdownSourceEditorSearchReplace, bool> HasFocusProperty =
        AvaloniaProperty.RegisterDirect<MarkdownSourceEditorSearchReplace, bool>(nameof(HasFocus), o => o.HasFocus);
        ...
        public MarkdownSourceEditorSearchReplace(MarkdownSourceEditor editor) : this()
        {
            this.Editor = editor;
        ...
        public MarkdownSourceEditorSearchReplace()
        {
