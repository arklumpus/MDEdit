...
namespace MDEdit
{
    internal class MarkdownSourceEditor : Control, ILogicalScrollable
    {
        internal static readonly DirectProperty<MarkdownSourceEditor, ImmutableList<HighlightedLineRange>> HighlightedLinesProperty =
        AvaloniaProperty.RegisterDirect<MarkdownSourceEditor, ImmutableList<HighlightedLineRange>>(
        ...
        public MarkdownPipeline ParserPipeline { get; set; } = new MarkdownPipelineBuilder().UseGridTables().UsePipeTables().UseEmphasisExtras().UseGenericAttributes().UseAutoIdentifiers().UseAutoLinks().UseTaskLists().UseListExtras().UseCitations().UseMathematics().UseSmartyPants().Build();
        public MarkdownDocument ParsedDocument { get; set; } = null;
        public bool DocumentNeedsParsing { get; set; } = true;
        public bool EverRenderedPreview { get; set; } = false;
        ...
        private FontFamily _fontFamily = FontFamily.Parse("resm:MDEdit.Fonts.?assembly=MDEdit#Roboto Mono");
        ...
        public Size Extent
        {
            get
            {
                ...
                return new Size(maxWidth * CharacterWidth + 25 + this.LineNumbersWidth, Text.Lines.Count * LineSpacing * FontSize);
            }
        }
        ...
        internal Typeface Typeface { get; private set; } = new Typeface(FontFamily.Parse("resm:MDEdit.Fonts.?assembly=MDEdit#Roboto Mono"));
        internal Typeface BoldTypeface { get; private set; } = new Typeface(FontFamily.Parse("resm:MDEdit.Fonts.?assembly=MDEdit#Roboto Mono"), weight: FontWeight.Bold);
        internal Typeface ItalicTypeface { get; private set; } = new Typeface(FontFamily.Parse("resm:MDEdit.Fonts.?assembly=MDEdit#Roboto Mono"), style: FontStyle.Italic);
        internal Typeface BoldItalicTypeface { get; private set; } = new Typeface(FontFamily.Parse("resm:MDEdit.Fonts.?assembly=MDEdit#Roboto Mono"), style: FontStyle.Italic, weight: FontWeight.Bold);
        ...
        internal MarkdownSourceEditorCaret CaretLayer { get; }
        internal MarkdownSourceEditorText TextLayer { get; }
        internal MarkdownSourceEditorSelection SelectionLayer { get; }
        internal MarkdownSourceEditorLineNumbers LineNumbersLayer { get; }
        internal MarkdownSourceEditorSearchReplace SearchReplace { get; }
        internal MarkdownSourceEditorScrollBarMarker ScrollBarMarker { get; }
        ...
        public MarkdownSourceEditor()
        {
            ...
            ProjectInfo projectInfo = ProjectInfo.Create(ProjectId.CreateNewId(), VersionStamp.Create(), "MarkdownEditor", "MarkdownEditor", "C#");
            workspace.AddProject(projectInfo);
            this.Document = workspace.AddDocument(projectInfo.Id, "Source.md", this.Text);
            ...
            try
            {
                FocusableProperty.OverrideDefaultValue<MarkdownSourceEditor>(true);
            }
            ...
            this.SelectionLayer = new MarkdownSourceEditorSelection(this);
            this.TextLayer = new MarkdownSourceEditorText(this);
            this.CaretLayer = new MarkdownSourceEditorCaret(this);
            this.LineNumbersLayer = new MarkdownSourceEditorLineNumbers(this);
            ...
            this.SearchReplace = new MarkdownSourceEditorSearchReplace(this) { Margin = new Thickness(0, 0, 18, 0) };
            ...
            this.ScrollBarMarker = new MarkdownSourceEditorScrollBarMarker(this);
        }
...
#pragma warning disable CS0618 // Il tipo o il membro è obsoleto
        protected override void OnPointerPressed(PointerPressedEventArgs e)
        {
            if (e.GetCurrentPoint(this).Properties.PointerUpdateKind == PointerUpdateKind.LeftButtonPressed)
            {
                ...
                int column = Math.Max(0, (int)Math.Round((position.X + this.Offset.X + 2 - (25 + this.LineNumbersWidth)) / this.CharacterWidth));
...
#pragma warning restore CS0618 // Il tipo o il membro è obsoleto
        ...
        public void ScrollToCaret()
        {
            ...
            double caretX = pos.Character * this.CharacterWidth + 25 + this.LineNumbersWidth;
            ...
            {
                oX = caretX - (25 + this.LineNumbersWidth);
            }
